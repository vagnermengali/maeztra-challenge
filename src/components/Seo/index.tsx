...
const Seo = ({ title, description, url }: { title: string, description: string, url: string }) => {
    return (
        <Head>
            <meta name="author" content="Tekoa" />
            <meta name="keywords" content="Javascript" />
            <link rel="fluid-icon" href="/assets/favicons/favicon.svg" title="Tekoa" />
            ...
            <meta property="al:ios:app_name" content="Tekoa" />
            <meta property="al:ios:url" content={url} />
            <meta property="al:android:app_name" content="Tekoa" />
