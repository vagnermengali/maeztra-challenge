              ...
              <div>
                ...
                <div className="flex flex-col gap-2 pt-2 pb-4 px-[27px]">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <p className="xl:h-12 2xl:h-auto font-normal text-brand2 text-base">{product.title}</p>
                    <p className="xl:h-[72px] 2xl:h-auto  max-w-60 font-normal text-brand2 text-xs leading-[18px]">{product.description}</p>
                    <button className="bg-brand1 text-brand10 hover:text-brand4 rounded h-[35px] w-full font-normal text-base transition-all ease-in-out duration-500">Adicionar</button>
                  </div>
                </div>
              </div>
            </Link>
