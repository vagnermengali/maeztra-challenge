        ...
        <>
            {
                ...
                <>
                    ...
                    <div className="fixed flex flex-col items-end w-[298px] md:w-96 lg:w-[851px] h-[307px] md:h-[558px] z-50 top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2">
                        <button className="text-xs leading-5 text-brand10 uppercase" onClick={closePopUp}>Fechar</button>
                        <div className="bg-brand10 w-full h-full flex flex-row justify-between">
                            <Image className="w-1/2 hidden lg:flex" src="/assets/images/bg-newsletter.png" width="426" height="532" alt="" aria-label="" />
                            <div className="flex flex-col items-center justify-center w-full lg:w-1/2 p-5 md:p-[51px]">
                                {submitted ?
                                    <>
                                        <FaRegCircleCheck className="w-16 h-16 text-green-500 mb-7" />
                                        <p className="text-brand6 text-xl leading-6 font-normal text-center mb-[26px]">Obrigado por se inscrever! Entraremos em contato em breve.</p>
